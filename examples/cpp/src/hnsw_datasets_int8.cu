 ...
 */
 ...
 int main(int argc, char *argv[])
 {
    ...
    //                                                                                                               dataset.view());
    //      std::cout << "Making host matrix to store quantized dataset" << std::endl;
    //      auto quantized_dataset = raft::make_host_matrix<int8_t, int64_t>(dataset.rows(), dataset.cols());
    //      std::cout << "Transforming dataset to quantized dataset" << std::endl;
    ...
    //  }
     ...
     BinaryFile<int8_t> quantized_dataset(quant_path.c_str(), max_dataset_rows);
